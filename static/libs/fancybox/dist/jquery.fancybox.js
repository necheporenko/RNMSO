...
(function(window, document, $, undefined) {
  ...
  var defaults = {
    ...
    baseTpl:
      ...
      '<div class="fancybox-thumbnails-arrow">{{thumbnails}}</div>' +
      ...
      $container = $(
        self.translate(
          ...
          firstItemOpts.baseTpl
            ...
            .replace("{{thumbnails}}", firstItemOpts.btnTpl.thunbsLeft + firstItemOpts.btnTpl.thunbsRight)
        )
      )
